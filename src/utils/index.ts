...
export const gameInfo = [
  {
    title: 'Jogo offline habilitado',
    icon: gameOfflineIcon,
  },
  ...
  {
    title: 'Compátivel com uso remoto',
    icon: useRemoteIcon,
  },

  {
    title: 'Função de vibração necessária',
    icon: vibrationIcon,
  },

  {
    title: 'Efeito gatilho necessário',
    icon: effectIcon,
  },

  {
    title: 'Compatível com a ajuda do jogo',
    icon: psnIcon,
  },
]
